...
- Commenting is blocked on moderated posts with `403`. Private posts you do not own, drafts, team posts you are not a member of, and posts by a suspended user return `404`.
