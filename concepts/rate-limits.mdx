...
`POST /upload` also has an abuse safeguard. Sending 8 or more uploads within one second suspends your account. Suspended accounts lose upload access and must contact support to appeal.
