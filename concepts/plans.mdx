...
| **Priority Streaming** | 10 min/month | 100 min/month | Custom |
...
<Note>
  Per-video caps apply: **60 minutes** and **200 MB**. A video over either limit always plays in standard quality regardless of how much budget you have left.
</Note>

The priority-minutes budget uses a rolling 30-day window: it is anchored to first use and fully resets after 30 days.
