...
If your domain is on Cloudflare, the easiest path is [**Bulk Redirects**](https://developers.cloudflare.com/rules/url-forwarding/bulk-redirects/).
...
A visit to `example.com/[code]` will resolve to `snipp.gg/p/[code]`.
