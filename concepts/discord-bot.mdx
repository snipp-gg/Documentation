...
Before using the bot, link your Discord account at [snipp.gg](https://snipp.gg). The bot looks up your Snipp profile by Discord ID. Without a linked account, every command returns a "No Snipp Account Found" prompt.
...
Shows your current plan, max file size, and weekly usage with a progress bar. When the weekly cap is hit the embed turns red and shows the reset time (e.g. `Resets Mon 3:00 PM`).
...
Weekly Usage: 12.4 GB / 50.0 GB (24.8%)
████░░░░░░░░░░░░░░░░
Resets Mon 3:00 PM
```
